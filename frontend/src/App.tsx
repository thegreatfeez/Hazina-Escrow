  ...
  return (
    <div className="min-h-screen pt-28 flex items-center justify-center text-center px-4">
      <div>
        ...
        <p className="text-foreground-muted font-body mb-8">This page doesn't exist in the vault.</p>
        <a href="/" className="btn-gold px-8 py-3 text-sm inline-block">Return Home</a>
      </div>
    </div>
  );
}
